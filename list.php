...
<head>
    ...
    <title>FYPM- View Assigned Topics</title>
...
<body>
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    ...
                    <?php }else{?>
                    <li>
                            <a href="list.php"><i class="fa fa-dashboard fa-fw"></i> Dashboard</a>
                        </li>
                        <li><a href="login.php"><i class="fa fa-sign-in fa-fw"></i> Login</a>
                    <?php }?>
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">View Assigned Student with topic</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                           Project Topic List with Students Details
                        </div>
                        <!-- /.panel-heading -->
                        <div class="panel-body">
                            <div class="dataTable_wrapper">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                    <?php
                                    $query = "SELECT * FROM topics INNER JOIN users on topics.lecturer_username = users.username";
                                    $run_query = mysqli_query($dbc,$query);
                                    while($data = mysqli_fetch_assoc($run_query)){
                                    ?>
                                        <tr class="odd gradeX">
                                            <td><?php echo $data['student_name']; ?></td>
                                            <td><?php echo $data['student_matric']; ?></td>
                                            <td><?php echo $data['student_department']; ?></td>
                                            <td class="center"><?php echo $data['session']; ?></td>
                                            <td class="center"><?php echo $data['year']; ?></td>
                                            <td class="center"><?php echo $data['name']; ?></td>
                                            <td class="center"><?php echo $data['topic']; ?></td>
                                        </tr>
                                        <?php }?>
                                    </tbody>
                                </table>
